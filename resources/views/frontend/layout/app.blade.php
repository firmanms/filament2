								...
								<div class="card-body">
										...
										<div class="col-xxl-4">
											...
											<div class="row g-5 g-xl-8">
												...
												<div class="col-xxl-12">
													<center><a href="https://simpus.bandungkab.go.id/daftaronline/" class="btn btn-success" style="width:100%;margin-bottom: 20px;">DAFTAR ANTRIAN PUSKESMAS</a></center>
									...
									<div class="row g-5 g-xl-12">
										...
										<div class="col-xxl-12">
											<div class="card shadow-sm card-xl-stretch mb-5 mb-xl-8">
												<div class="card-header">
													<h3 class="card-title">Berita Pemerintah kabupaten Bandung</h3>
                                                            ...
                                                            <div class="tns tns-default mb-10">
                                                                ...
                                                                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 3}, 992: {items: 2}}">
                                                                    ...
                                                                    <div class="text-center">
                                                                        <a href="{{ $item->url}}" class="pentagon mx-auto mb-5 d-flex w-100% h-70px bgi-no-repeat bgi-size-contain bgi-position-center" style="background-image:url('{{ url('storage/'.$item->image .'') }}')"></a>
                                                                        {{-- <img src="{{ url('storage/'.$item->image .'') }}" height="70" width="100%" class=""> --}}
                                                                    </div>
                                                                    <!--end::Item-->
                                                                    @endforeach
                                                                </div>
									...
									<div class="mb-20">
										<!--begin::Title-->
										<h1 class="fs-2x text-gray-800 w-bolder mb-6">Frequesntly Asked Questions</h1>
										<!--end::Title-->
										<!--begin::Text-->
										<p class="fw-bold fs-4 text-gray-600 mb-2">sekumpulan pertanyaan yang sering diajukan oleh pengguna atau pembaca, beserta jawaban yang singkat dan jelas.</p>
										<!--end::Text-->
									</div>
									<!--end::Intro-->
									<!--begin::Row-->
									<div class="row mb-20">
										...
										<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
											<!--begin::Title-->
											<h1 class="text-gray-800 fw-bolder mb-4">Pertanyaan umum</h1>
											<!--end::Title-->
											<!--begin::Accordion-->
                                            @foreach ( $faq as $item )
											<!--begin::Section-->
											<div class="m-0">
												<!--begin::Heading-->
												<div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0" data-bs-toggle="collapse" data-bs-target="#idnya_{!! $item->id !!}">
													<!--begin::Icon-->
													...
													<!--end::Icon-->
													<!--begin::Title-->
													<h4 class="text-gray-700 fw-bolder cursor-pointer mb-0">{!! $item->question !!}</h4>
													<!--end::Title-->
												</div>
												<!--end::Heading-->
												<!--begin::Body-->
												<div id="idnya_{!! $item->id !!}" class="collapse fs-6 ms-1">
													<!--begin::Text-->
													<div class="mb-4 text-gray-600 fw-bold fs-6 ps-10">{!! $item->answer !!}</div>
													<!--end::Text-->
												</div>
												<!--end::Content-->
												<!--begin::Separator-->
                                    ...
                                    <div class="card bg-light text-center">
                                        ...
                                        <div class="card-body py-12">
                                            <!--begin::Icon-->
                                            <a href="#" class="mx-4">
                                                <img src="http://127.0.0.1:8000/storage/logo/1/1705025666logokab.png" class="h-30px my-2" alt="" />
                                            </a>
                                            <!--end::Icon-->
                                            <!--begin::Icon-->
                                            <a href="#" class="mx-4">
                                            ...
                                            <!--begin::Icon-->
                                            <a href="#" class="mx-4">
                                                <img src="file:///D:/laragon/www/filament2/public/frontend/assets/media/svg/brand-logos/dribbble-icon-1.svg" class="h-30px my-2" alt="" />
                                            </a>
                                            <!--end::Icon-->
                                        </div>
                                        <!--end::Body-->
