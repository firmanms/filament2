              ...
              <div class="entry-content">
                ...
                <section id="faq" class="faq">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                        <!-- F.A.Q List 1-->
                        <div class="accordion accordion-flush" id="layananlist1">
                            @foreach($layanan as $layanans)
                            <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#layanan-content-{{ $layanans->id }}">
                                {!! $layanans->name !!}
                                </button>
                            </h2>
                            <div id="layanan-content-{{ $layanans->id}}" class="accordion-collapse collapse" data-bs-parent="#layananlist1">
                                <div class="accordion-body">
                                <b>Nama Layanan :</b><br>
                                {!! $layanans->name !!}<br><br>
                                <b>Persyaratan :</b><br>
                                {!! $layanans->requirement !!}<br>
                                <b>Mekanisme/Prosedur :</b><br>
                                {!! $layanans->procedure !!}<br>
